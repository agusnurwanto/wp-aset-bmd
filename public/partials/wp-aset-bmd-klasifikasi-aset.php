...
$color = array('red', 'green', 'blue', 'black', 'purple', 'orange');
...
foreach($data_aset as $i => $val){
    ...
    $body_skpd .= '
        <tr>
            ...
            <td>'.$val->Nm_Unit.'</td>
            <td class="text-right harga_total" data-kd_lokasi="'.$val->kd_lokasi.'" data-order="'.$val->harga_asli.'">'.$val->harga_asli.'</td>
