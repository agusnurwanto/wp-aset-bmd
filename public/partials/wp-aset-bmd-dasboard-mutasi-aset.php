...
foreach($query->posts as $post){
    ...
    $keterangan_mutasi_aset = get_post_meta($post->ID, 'meta_keterangan_mutasi_aset', true);
    ...
    $body .= '
        <tr>
            ...
            <td>'.$keterangan_mutasi_aset.'</td>
            <td class="text-right" data-sort="'.$nilai_aset.'">'.number_format($nilai_aset,2,",",".").'</td>
            <td class="text-center"><a title="'.$link['title'].'" href="'.$link['url'].'" class="btn btn-primary">Detail</a></td>
        </tr>
    ';
...
<div class="cetak">
    <div style="padding: 10px;">
        <h2 class="text-center">Data Mutasi Aset<br><?php echo $nama_pemda; ?><br>Tahun <?php echo $tahun_anggaran; ?></h2>
        <table class="table table-bordered" id="data_aset_aset">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Keterangan Mutasi Aset</th>
