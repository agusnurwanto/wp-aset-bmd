            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <textarea <?php echo $disabled; ?> class="form-control" name="keterangan_kondisi_aset" placeholder="Keterangan Kondisi Aset Perlatan Mesin"><?php echo $keterangan_kondisi_aset; ?></textarea>
                </div>
            </div>
            <div class="form-group row">
