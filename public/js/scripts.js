...
if (typeof chart_jenis_aset == "undefined") {
  chart_jenis_aset = {
    label: ["Tanah", "Peralatan dan Mesin", "Gedung dan Bangunan", "Jalan, Jaringan dan Irigrasi", "Aset Tetap Lainya", "Kontruksi Dalam Pengerjaan"],
    data: [10, 23, 345, 3, 6, 0],
    color: ["rgba(255, 99, 132, 1)", "rgba(54, 162, 235, 1)", "rgba(255, 206, 86, 1)", "rgba(75, 192, 192, 1)", "rgba(153, 102, 255, 1)", "rgba(255, 159, 64, 1)"],
  };
} else {
